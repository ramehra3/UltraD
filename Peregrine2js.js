...
let case2 = new CaseData(28, //age
    "female", //gender
    "presents to the ED after crashing her bicycle into a tree. She denies any head trauma or loss of consciousness.", 
    123, //BPsys
    78,  //BPdia
    84, //HR
    37.1, //Tcelcius (neec conversion)
    94 ); //O2 Saturation

document.getElementById("caseDetails").innerHTML =
    ("A " + case2.age + "-year-old " + case2.gender + " " + case2.scenario);
document.getElementById("BP").innerHTML =("BP: " + case2.bpsys + "/" + case2.bpdia);
document.getElementById("HR").innerHTML =("HR: " + case2.hr);
document.getElementById("T").innerHTML =("T: " + case2.tempc +"°C"); //fix degree symbol//
document.getElementById("O2").innerHTML =("spO2: " + case2.oxy +"%");
...
function actionObs() {
    ...
    window.location.href = "Outcome2-Obs.html";
}


function actionCT() {
    actionChoice = "CT Scan";
    window.location.href = "Outcome2-CT.html";
}

function actionSurg() {
    actionChoice = "Surgery";
    window.location.href = "Outcome2-Surg.html";
}

function actionIntervene() {
    actionChoice = "Intervention";
    window.location.href = "Outcome2-Intervene.html";
}
/*
class caseOutcomes {
